...
const featuredProducts = [
  {
    ...
    price: 1299,
    rating: 4.8,
    image: "" // Add product image URL here if available
  },
  {
    ...
    <div className="flex gap-6 flex-wrap justify-center">
      {featuredProducts.map((product, idx) => (
        <div key={idx} className="w-[260px] bg-white rounded-xl shadow-md p-4 flex flex-col">
          <div className="h-36 rounded-xl bg-gray-100 mb-4 flex items-center justify-center">
            {/* Optionally render product.image */}
...
const LandingPage = () => {
  ...
  <div className="flex items-center gap-2 flex-shrink-0">
    <div className="bg-[#FFA726] text-white font-bold rounded-lg w-9 h-9 flex items-center justify-center text-base mr-2">AH</div>
    <span className="text-lg font-bold text-[#232945]">ArtisanHub</span>
  </div>
    ...
    <div className="w-7 h-7 bg-gray-100 rounded-full"></div>
      ...
      <section className="hero-section relative z-10 min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-6xl mx-auto relative z-20">
          <div className={`mb-8 transform transition-all duration-1000 ${showAnimation ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-white to-yellow-200 bg-clip-text text-transparent">ArtisanHub</h1>
      ...
      <section className="py-20 px-4 cultural-pattern">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-gray-800">Why Choose <span className="text-vermilion">ArtisanHub</span>?</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-emerald to-turquoise">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16 text-black">Making a <span className="text-yellow-200">Real Difference</span></h2>
